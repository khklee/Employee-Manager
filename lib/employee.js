...
const getManagerId = `SELECT first_name, last_name, role_id FROM employee WHERE manager_id IS NULL;`;

const getName = `SELECT * FROM employee`;

const addNewRole = `UPDATE employee SET role_id = ? WHERE id = ?`;

module.exports = [ viewEmployee, addEmployee, getManagerId, getName, addNewRole ];